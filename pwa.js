...
const cacheName = 'ErinEppersonMidterm_appstudio-2021-03-15 16:42:51.803956'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ErinEppersonMidterm_appstudio'.length) === 'ErinEppersonMidterm_appstudio') {
